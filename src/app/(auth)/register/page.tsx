                ...
                <div className="z-10 max-w-lg">
                    <div className="mb-6">
                        ...
                        <p className="text-zinc-400 text-lg">
                            Get unlimited access to structured courses, live
                            doubt solving, and premium study material.
                        </p>
                    </div>

                    <div className="flex gap-3">
                        <div className="bg-zinc-800/50 border border-zinc-700 px-3 py-1 rounded-full text-xs text-zinc-300">
                            🚀 500+ Selections in JEE
                        </div>
                        <div className="bg-zinc-800/50 border border-zinc-700 px-3 py-1 rounded-full text-xs text-zinc-300">
                            🩺 300+ Selections in NEET
                        </div>
                    </div>
                </div>
